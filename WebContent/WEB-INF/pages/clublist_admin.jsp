...
<body>
		...
		<table
			...
			<c:forEach var="club" items="${clubs}">
				<tr style="border: 2px solid orange; height: 30px">
					...
					<td>${club.clubInfo}</td>
					<td>
						<a href="${pageContext.request.contextPath}/club/removeClub?clubId=${club.clubId}&privilege=${sessionScope.user.privilege}" onclick="javascript:return del();">删除社团</a>
					</td>
				</tr>
			</c:forEach>
		</table>
	...
	<div>
		...
		<a
			href="${pageContext.request.contextPath}/club/page?pageNo=${totalPage}&privilege=${sessionScope.user.privilege}">最后一页</a>
	</div>
